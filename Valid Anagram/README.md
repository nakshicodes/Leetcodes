...
**Files:** [`myTrialSolution1.py`](Valid%20Anagram/myTrialSolution1.py) · [`myTrialSolution2.py`](Valid%20Anagram/myTrialSolution2.py) · [`workingSolution1.py`](Valid%20Anagram/WorkingSolution1.py) · [`workingSolution2&3.py`](Valid%20Anagram/workingSolution2%263.py)
